        ...
        <div className="flex items-center justify-between px-6 py-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex bg-gray-800/50 rounded-lg p-0.5">
              <button
                ...
                className={`px-2 py-1 text-xs font-medium rounded-md transition-colors ${
                  lang === "ko" ? "bg-gray-600 text-white" : "text-gray-400 hover:text-gray-200"
                }`}
              >
                KO
              </button>
              <button
                onClick={() => setLang("en")}
                className={`px-2 py-1 text-xs font-medium rounded-md transition-colors ${
                  lang === "en" ? "bg-gray-600 text-white" : "text-gray-400 hover:text-gray-200"
                }`}
              >
                EN
              </button>
            ...
            <nav className="flex bg-gray-800/50 rounded-lg p-0.5">
              ...
              <span className="px-4 py-1.5 text-sm font-medium rounded-md bg-blue-600 text-white">
