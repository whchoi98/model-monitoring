...
- `ClaudeFeaturesPanel.tsx` — Claude API Features: 4열(CP/Mantle/InvokeModel/Converse) 매트릭스, 문서 드리프트 배너, 셀 클릭 시 증거 모달(요청 스냅샷·응답 신호·문서 링크·검증 강도), 수동 트리거 (`lib/claudeFeatures.ts` 순수 로직, v2.23.0)
