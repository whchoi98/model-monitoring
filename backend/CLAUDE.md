...
- `features_runner.py` — CLI entrypoint for the scheduled FeaturesVerify task (daily `cron(30 17 * * ? *)` Etc/UTC = 02:30 KST since v2.29.0, previously `rate(24 hours)`): `python -m features_runner --once` (v2.23.0)
