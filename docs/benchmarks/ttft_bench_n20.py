...
OPENAI_1P_KEY = ssm_get("/bedrock-monitor/openai-1p-api-key")
...
CHANNELS = [
    ...
    ("1P (global)",      "https://api.openai.com/v1",                          OPENAI_1P_KEY, "gpt-5.4"),
    ("1P (global)",      "https://api.openai.com/v1",                          OPENAI_1P_KEY, "gpt-5.5"),
]
