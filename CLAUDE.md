...
Internal ALB
  ...
  └── /*      → frontend Fargate Task (Next.js standalone, port 3000)
                ...
                ├── /gpt-on-aws   — GPT on AWS (GPT 12채널 TTFB/TTFT 벤치 — Mantle 인리전 9 + CRIS 3 — Terra Global 포함 v2.20.1, GPT-6 Astra 3채널 v2.25.1, 15분 주기)
...
│   ├── gptbench.py          # GPT on AWS 벤치 사이클 (GPT 12채널 = Mantle 인리전 9 + CRIS 3, × 10회 — Terra Global 포함 v2.20.1, GPT-6 Astra 3채널 v2.25.1, TTFB/TTFT/GAP)
