...
Internal ALB
  ...
  └── /*      → frontend Fargate Task (Next.js standalone, port 3000)
                ...
                ├── /gpt-on-aws   — GPT on AWS (Mantle 12채널 TTFB/TTFT 벤치 — Terra Global 포함 v2.20.1, GPT-6 Astra 3채널 v2.25.1, 15분 주기)
...
EventBridge Scheduler (rate 5 min)
  ...
  ├── GptBench Fargate Task    → 15분 주기 Mantle GPT 12채널 × 10회 TTFB/TTFT 벤치 (v2.18.0; Terra Global CRIS 포함 v2.20.1, GPT-6 Astra 3채널 v2.25.1)
...
│   ├── gptbench.py          # GPT on AWS 벤치 사이클 (Mantle 12채널 × 10회 — Terra Global 포함 v2.20.1, GPT-6 Astra 3채널 v2.25.1, TTFB/TTFT/GAP)
